...
def GestisciLogin():
    ...
    if content_type == 'application/json':
        ...
        sQuery = "select stato from utenti where username='" + sUsernameInseritoDalClient + "' and password='" + sPasswordInseritaDalClient + "';"  
        print(sQuery)
...
def read_cittadino(codice_fiscale):
    ...
    if iNumRecords != 1:
        ...
        print(dResponse)
        #cittadino = {"nome":"mario", "cognome":"rossi", "dataNascita":"06/03/1900"}
